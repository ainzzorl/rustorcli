...
pub const MAX_OUTSTANDING_REQUESTS_PER_PEER: i32 = 100;
pub const MAX_REQUESTS_PER_TICK_PER_DOWNLOAD: usize = 300;
...
pub const MAX_INCOMING_MESSAGES_PER_TICK_PER_DOWNLOAD: u32 = 300;
